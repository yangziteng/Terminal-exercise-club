          ...
          {{img==false?'+':'已上传'}}
                    ...
                    <view class="list_item" v-for="(item, index) in list" :key="index">
                        <view style="display: flex; flex: 1" v-if="item.title == '社团介绍'">
                            ...
                            <textarea :placeholder="item.placeholder" style="height: 230rpx" class="rigth" :name="item.id" :type="item.type" :value="item.value" maxlength="300" />
                        </view>
...
export default {
  ...
  //       search() {
        ...
        goFreshmanData() {
            ...
            uni.navigateTo({
                url: `/pages/association/freshmanData/freshmanData?count=${count}`
            });
        },
        ...
        match() {
            if (this.adminCard) {
                uni.navigateTo({
                    url: '/pages/association/match/match?count=' + this.adminCard
                });
            } else {
                uni.navigateTo({
        ...
        freshman() {
            ...
            let count = this.adminCard;
            uni.navigateTo({
                url: '/pages/association/freshman/freshman?assoMess=' + assoMess + '&erweimaUrl=' + erweimaUrl + '&count=' + count
            });
        },
